  ...
  static void Main()
  {
    ...
    var allMethods = Assembly.GetExecutingAssembly()
      ...
      .SelectMany(t => t.GetMethods(BindingFlags.Public | BindingFlags.Static)
        .Where(m => m.Name.StartsWith("Praktik") | m.Name.StartsWith("Tugas") | m.Name.StartsWith("Latihan") | m.Name.StartsWith("PercabanganSwitchCase") | m.Name.StartsWith("Contoh") | m.Name.StartsWith("PercabanganIfElse")))
      .ToList();
    ...
    var selectedNamespace = Prompt.Select("𓂃˖˳·˖ ִֶָ ⋆ Pilih namespace ⋆ ִֶָ˖·˳˖𓂃 ִֶָ", namespaces);
    ...
    var selectedMethod = Prompt.Select($"Pilih project dari {selectedNamespace}", options);
